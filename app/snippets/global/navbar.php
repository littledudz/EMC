...
<header id="header" class="sticky">
	<header class="">
		<nav class="secondNav" id="secondNav-mobile">
			<div class="logo-container"><a class="logo" href="http://emcbham.com/"><img id="nav-logo" src="support/images/emc-birmingham-logo-dark.png" alt="emc-birmingham-logo-iso"></a></div>

    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
			...
			<div class="col-md-12">
				<div class="g-recaptcha" data-sitekey="6LdZdygTAAAAAAtJxXG51pNFnPSIl4q9Bim-WWdy"></div><br>
...
<!--
			<div class="clearfix">
				<div class="g-recaptcha" data-sitekey="6LdZdygTAAAAAAtJxXG51pNFnPSIl4q9Bim-WWdy"></div>
				<button type="submit" class="btn btn-primary col-xs-12 col-sm-6 col-sm-offset-3">Submit</button><br><br>
			</div>
-->
		</form>

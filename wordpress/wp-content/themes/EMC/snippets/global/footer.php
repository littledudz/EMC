	...
	<div class="container">
		<div class="row">
			<div class="logo_footer dark col-md-4 col-sm-4">
				<img alt="" src="<?php bloginfo( 'wpurl' );?>"><img src="<?php bloginfo('template_directory');?>/support/images/emc-birmingham-logo-dark.jpg" height="50" class="EMC Birmingham logo">
				<p class="block">
					EMC Birmingham<br>
